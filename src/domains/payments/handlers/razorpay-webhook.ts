...
export async function razorpayWebhookHandler(request: NextRequest) {
  ...
  if (!secret) {
    logger.warn(
      "RAZORPAY_WEBHOOK_SECRET unset; accepting webhook without verification (non-production only)",
    );
